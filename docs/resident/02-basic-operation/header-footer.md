...
メインコンテンツは、さらに次の構成になっています（「特徴」ページを例に説明します）。

### サブヘッダー

各ページの上部には「**サブヘッダー**」があります。
ページタイトルと、そのページ内のセクション見出しへのリンクがまとまっています。

![サブヘッダー（特徴ページの例）](../images/features-subheader.png)

リンクをクリックすると、そのセクションまで自動的にスクロールします。

### コンテンツ部分

サブヘッダーの下に、各セクションの本文・画像・表などが続きます。
